...
const ListingPage = () => {
  ...
  return (
    <div className="bg-blue-50">
      ...
      <div className="max-w-6xl px-6 mx-auto py-8">
        <div className="bg-white p-5 rounded-md shadow-md py-10">
          <p className="text-2xl text-blue-700 font-semibold">${house.price}</p>
          <div className="flex gap-4 pt-12 md:flex-row flex-col">
            <p className="flex gap-2 items-center">
              <span className="bg-indigo-100 text-gray-500 text-md py-1.5 px-1.5 rounded-full">
                <BiBed />
              </span>
        ...
        <div className="bg-white p-5 rounded-md shadow-md my-10">
          ...
          <div className="flex flex-col max-w-xs gap-y-4">
            <p className="grid grid-cols-2">
              <span className="text-md text-gray-800 font-semibold">
                Garage
              </span>
              <span className="text-md text-gray-400 font-semibold">1</span>
            </p>
            <p className="grid grid-cols-2">
              <span className="text-md text-gray-800 font-semibold">
                Area Size (Sqft)
              </span>
              <span className="text-md text-gray-400 font-semibold">1200</span>
            </p>
            <p className="grid grid-cols-2">
              <span className="text-md text-gray-800 font-semibold">
                Bedrooms
              </span>
              <span className="text-md text-gray-400 font-semibold">4</span>
            </p>
            <p className="grid grid-cols-2 mb-5">
              <span className="text-md text-gray-800 font-semibold">
                Washroom
              </span>
              <span className="text-md text-gray-400 font-semibold">3</span>
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-md shadow-md my-8">
          <div className="flex justify-between py-3">
            <p className="text-lg text-gray-800 font-semibold">Amenities</p>
            <p>.</p>
          </div>
          <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
            <p className="flex gap-2">
              <span className="bg-green-100 text-green-500 text-md py-1.5 px-1.5 rounded-full">
                <AiOutlineCheck />
              </span>
              <span className="text-md text-gray-500 font-semibold">
                Air Conditioning
        ...
        <div className="bg-white p-5 rounded-md shadow-md my-10">
          <div className="flex justify-between">
            <p className="text-md text-gray-800 font-semibold">Property View</p>
            <p>.</p>
          </div>
        ...
        <div className="bg-white p-5 rounded-md shadow-md my-10">
          <div className="flex justify-between">
            <p className="text-md text-gray-800 font-semibold">Floor Plan</p>
            <p>.</p>
          </div>
          <div className="flex flex-col max-w-xs gap-y-6"></div>
        </div>
        ...
        <div className="bg-white p-5 rounded-md shadow-md my-10">
          <div className="flex justify-between">
            <p className="text-md text-gray-800 font-semibold">Location</p>
            <p>.</p>
          </div>
          <div className="flex flex-col max-w-xs gap-y-6"></div>
        </div>
        ...
        <div className="bg-white p-5 rounded-md shadow-md my-10">
          <div className="flex justify-between">
            <p className="text-md text-gray-800 font-semibold">Gallery</p>
            <p>.</p>
          </div>
          <div className="flex flex-col max-w-xs gap-y-6"></div>
        </div>
        ...
        <div className="bg-white p-5 rounded-md shadow-md my-10">
          <div className="flex justify-between">
            <p className="text-md text-gray-800 font-semibold">Ratings</p>
            <p>.</p>
          </div>
          <div className="flex flex-col max-w-xs gap-y-6"></div>
        </div>
